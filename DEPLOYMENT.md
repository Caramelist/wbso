...
- ✅ Firebase project set up (`wbso-application`)
...
curl https://europe-west1-wbso-application.cloudfunctions.net/api/status
```
...
NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=wbso-application.firebaseapp.com
NEXT_PUBLIC_FIREBASE_PROJECT_ID=wbso-application
NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET=wbso-application.firebasestorage.app
...
netlify env:set NEXT_PUBLIC_FIREBASE_PROJECT_ID "wbso-application"
...
# Test health check
curl https://europe-west1-wbso-application.cloudfunctions.net/api/health
```
